...
function Socialpublic() {
  ...
  function updateJoar() {
    ...
    var njdate = hours + ':' + minutes + ' ' + meridian



    
    var timeSplit = vdate.split(':'),
    hours,
    minutes,
    meridian;
    hours = timeSplit[0];
    ...
    var nvdate = hours + ':' + minutes + ' ' + meridian



    data.append("jdate", njdate); 
    data.append("vdate", nvdate);
  ...
  function updateBoat() {
    ...
    var nplaceOne = hours + ':' + minutes + ' ' + meridian





    var timeSplit = placeTwo.split(':'),
    hours,
    minutes,
    meridian;
    hours = timeSplit[0];
    ...
    var nplaceTwo = hours + ':' + minutes + ' ' + meridian


    const data = new FormData();
    data.append("placeOne", nplaceOne);
    data.append("placeTwo", nplaceTwo); 
  ...
  return (
    <div class="container-fluid panel-Background panel-BackgroundH py-4 px-5">
      ...
      <div class="productList px-1 mb-4">
